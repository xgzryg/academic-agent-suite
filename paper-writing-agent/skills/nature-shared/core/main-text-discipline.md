...
Retain the analyses required by the agreed design, protocol and reporting standard. A writing request does not itself authorize refitting, new analyses, multiplicity correction or changing a settled method choice; surface a material gap and perform additional analysis only within the actual authorization. In the main text, normally report:
