...
Nature-response has no fragment axis. Its variation is identified at runtime, not by loading different content bodies:
...
- Related writing and literature work uses the actual bundled routes; architectural comparisons to the former external skill ecosystem are not executable dependencies.
