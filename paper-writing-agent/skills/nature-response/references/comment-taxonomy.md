...
- For data-availability wording, use the bundled reproducibility-checklist and the manuscript Methods branch, preserving the actual access conditions, identifiers and restrictions.
