---
name: peer-review
description: Systematic peer review toolkit. Evaluate methodology, statistics, design,
  reproducibility, ethics, figure integrity, reporting standards, for manuscript and
  grant review across disciplines.
---
...
Only create figures when requested or needed to explain an actual finding. Use the bundled [artifact branch](../paper-research-artifacts/SKILL.md). Review the manuscript figures against their own source data; no default AI schematic.
...
Use the bundled [PDF branch](../paper-pdf/SKILL.md) to render each supplied slide and inspect the images for overflow, overlaps, clipped figures, readability, axes, legends and references. Text extraction supports content checking but does not replace visual inspection. Report actual slide positions and check only the requested slide scope. Presentation style ratios and font sizes are context-dependent guidance, not automatic defects.
...
<!--
[LobsterAI 迁移元数据]
original_frontmatter: {"name": "peer-review", "description": "Systematic peer review toolkit. Evaluate methodology, statistics, design, reproducibility, ethics, figure integrity, reporting standards, for manuscript and grant review across disciplines.", "allowed-tools": ["Read", "Write", "Edit", "Bash"]}
-->
