> Applicability: these are diagnostic prompts, not automatic defects. Small n, a nonzero axis origin, ordinal data, incomplete public data access, or no multiplicity correction require study-specific judgement. Existing analysis choices are not automatically refitted.
...
- Report precision (confidence interval width); do not use observed post-hoc power as evidence of adequacy
