...
description: 'Use this Skill to write structured academic peer-review rebuttals: point-by-point
  responses, tone calibration, LaTeX templates, and cover letters for re-submission.

  '
description_en: 'Use this Skill to write structured academic peer-review rebuttals:
  point-by-point responses, tone calibration, LaTeX templates, and cover letters for
  re-submission.
...
license: MIT
visibility: public
display_name: rebuttal-writing
display_name_en: rebuttal-writing
agent_created: true
disable: false
---
...
<!--
[LobsterAI 迁移元数据]
original_frontmatter: {"name": "rebuttal-writing", "description": "Use this Skill to write structured academic peer-review rebuttals: point-by-point responses, tone calibration, LaTeX templates, and cover letters for re-submission.\n", "tags": ["universal", "rebuttal-writing", "peer-review", "academic-writing", "latex", "revision"], "version": "1.0.0", "authors": [{"name": "awesome-rosetta-skills contributors", "github": "@awesome-rosetta-skills"}], "license": "MIT", "platforms": ["claude-code", "codex", "gemini-cli", "cursor"], "dependencies": {"python": ["re>=3.11", "pathlib>=3.11"]}, "last_updated": "2026-03-17"}
-->
