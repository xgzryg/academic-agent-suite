...
Use this file to identify possible reviewer-risk patterns. Severity depends on the actual design, target claim and supporting evidence; a signal is not a proven error. Multiple testing requires an explicit analysis family and rationale, not automatic correction during a writing task. Respect a settled project reporting choice while reporting a real methodological concern. Do not accuse the authors; state the evidence, uncertainty and minimum justified remedy.
