...
Do not claim that a new analysis was performed unless its actual completed output is available from the user or from an authorized calculation you have finished and checked. A request or a launched job is not a completed result.
