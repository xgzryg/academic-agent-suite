...
> Retained source snapshot with its original verification date. Verify current official instructions when an exact submission rule affects the task; do not call the entire checklist newly verified by this package.
