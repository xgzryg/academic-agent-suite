...
1. **Target journal instructions and user-supplied protocol**
   ...
   - Reuse the agreed statistical analysis plan and assess reviewer requests against the real design. A stricter reviewer request does not automatically justify post-hoc changes; identify conflicts and resolve substantive choices with the author.
