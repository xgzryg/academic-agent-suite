...
- Help draft or restructure an authorized scientific argument from the supplied evidence. Do not invent its question, data, mechanism, novelty or conclusion.
...
AI may draft, polish, structure or compare phrasings within the user’s authorized scientific task. The supplied evidence and accountable author decisions govern the argument; unknown premises remain explicit gaps. If an argument is weak, identify the specific unsupported link instead of concealing it with fluent prose.
