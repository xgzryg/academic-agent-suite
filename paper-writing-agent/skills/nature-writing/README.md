...
- 如果需要先找文献支撑 claim，优先使用 `../litorchestrator/SKILL.md` 或 `../litorchestrator/SKILL.md`。
- 首次投稿材料由本技能处理；返修 cover letter、rebuttal 和逐点回复由 `nature-response` 处理。

## 相关技能

- `nature-polishing`：英文润色、翻译和风格收束。
- `../litorchestrator/SKILL.md`：为 claim 匹配支撑文献。
- `../nature-shared/core/figure-evidence-support.md`：把图件结论和面板设计对齐到正文叙事。
