...
- If claim support requires literature search first, use `../litorchestrator/SKILL.md` or `../litorchestrator/SKILL.md`.
...
- `../litorchestrator/SKILL.md`: match supporting references for claims.
- `../nature-shared/core/figure-evidence-support.md`: align figure conclusions and panel design with manuscript narrative.
