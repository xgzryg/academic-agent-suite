...
Graphical abstracts and TOC graphics belong to `../../../../nature-shared/core/figure-evidence-support.md`. Revision cover letters and rebuttals belong to `nature-response`.
