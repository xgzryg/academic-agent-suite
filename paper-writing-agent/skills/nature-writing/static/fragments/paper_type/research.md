...
Use the available Results to bound the Introduction. This is a suggested full-paper sequence, not a reason to refuse a requested Introduction when its evidence is already available.
