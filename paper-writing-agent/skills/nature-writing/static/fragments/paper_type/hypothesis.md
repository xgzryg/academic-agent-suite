...
Keep Results focused on observations, tests and the bounded inference directly supported by the design. Broader causal reconciliation and literature synthesis belong in Discussion; association alone does not support causation.
