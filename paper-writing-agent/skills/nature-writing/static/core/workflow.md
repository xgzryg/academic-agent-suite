...
Give each paragraph one controlling message, using context, gap, approach, result, comparison, mechanism, implication or limitation as useful function labels. Related evidence and a bounded interpretation may support that same message; do not split a coherent paragraph merely to satisfy a one-label quota.
